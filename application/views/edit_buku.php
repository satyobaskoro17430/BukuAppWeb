                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Judul</label>
                            <input type="text" class="form-control" name="judul" value="<?php echo $bukuid['judul']; ?>" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pengarang" value="<?php echo $bukuid['pengarang']; ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="penerbit" value="<?php echo $bukuid['penerbit']; ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="gambar_old" value="<?php echo $bukuid['gambar']; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
